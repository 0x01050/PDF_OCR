...
@section('smartapp-content')
        ...
        <div class="answer">
            <div>
                <select class="updatable" name="present_address_state" data-type="coborrower" data-model="address" style="width: calc(50% - 50px)">
                    <option {{ (!isset($coborrower_address_present_address_state) ? "selected" : "") }} disabled value="">Select a State</option>
        ...
        <div class="answer">
            <div>
                <select class="updatable" name="present_address_own_rent" data-type="coborrower" data-model="address" style="width: calc(50% - 50px)">
                    <option {{ (!isset($coborrower_address_present_address_own_rent) ? "selected" : "") }} disabled value="">Select</option>
    ...
    <div class="item-field">
        <div class="answer">
            <div>
                <input type='checkbox' {{ (isset($coborrower_address_address_is_mailing_address) && $coborrower_address_address_is_mailing_address == 'on' ? "checked" : "") }} class="updatable" name="address_is_mailing_address" data-type="coborrower" data-model="address" >
    ...
    <div class="item-field">
        <div class="answer">
            <div>
                <input type='checkbox' {{ (isset($coborrower_address_address_lived_less_than_2_years) && $coborrower_address_address_lived_less_than_2_years == 'on' ? "checked" : "") }} class="updatable" name="address_lived_less_than_2_years" data-type="coborrower" data-model="address" >
