...
@section('smartapp-content')
    ...
    <div class="item-field">
        ...
        <div class="answer">
            <div>
                <input type="radio" value="yes" class="updatable" name="ownership_interest" data-type="disclosures" data-model="coborrower" {{ (isset($disclosures_coborrower_ownership_interest) && $disclosures_coborrower_ownership_interest == "yes" ? "checked" : "") }}>
                Yes
            </div>
            <div>
                <input type="radio" value="no" class="updatable" name="ownership_interest" data-type="disclosures" data-model="coborrower" {{ (isset($disclosures_coborrower_ownership_interest) && $disclosures_coborrower_ownership_interest == "no" ? "checked" : "") }}>
                No
            </div>
        </div>
    </div>
